...
const WeatherWidgetChart = ({ aqhiChartData }) => {
    ...
    return (
       <div className="max-w-sm w-full bg-white rounded-b-lg shadow dark:bg-gray-800 px-4 pb-4">
            <div className="flex justify-between mb-5">
                <div className="grid gap-4 grid-cols-1">
                    <div>
                        <h6 className="inline-flex items-center text-gray-500 dark:text-gray-400 leading-none font-normal mb-2 text-sm">Forecast location</h6>
                        <p className="text-gray-900 dark:text-white text-lg leading-none font-bold">{aqhiLocName}</p>
                    </div>
                </div>
                <div>
                <button id="dropdownDefaultButton"
                    data-dropdown-toggle="lastDaysdropdown"
                    data-dropdown-placement="bottom" type="button" className="px-3 py-2 inline-flex items-center text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-sky-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700" disabled>Today<svg className="w-2.5 h-2.5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
            ...
            <div className="grid grid-cols-1 items-center border-gray-200 border-t dark:border-gray-700 justify-between mt-2.5">
                <div className="pt-5">      
                    <button className="px-3 py-2 text-sm font-medium text-white inline-flex items-center bg-slate-500 cursor-auto focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center dark:bg-sky-600 dark:hover:bg-sky-700 dark:focus:ring-sky-800" disabled>
